...
- Select advanced options
  ...
  - Swipe and keyboard support
    - Make sure you have hammerjs (https://www.drupal.org/project/hammerjs) installed to see this option
    - Currently support left and right arrow key and swiping to left and right gesture
    - flippy div class name changed in your custom twig template will make this feature un functional
